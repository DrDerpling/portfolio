                ...
                <div class="flex h-screen flex-col flex-1 overflow-y-auto"> <!-- Main content flex container -->
                    <header class="bg-primary-darkest flex items-center">
                        <div x-data="{}" class="lg:hidden p-2">
                            <button @click="$dispatch('open-sidebar')" id="menu" type="button" class="flex p-2 text-primary-lighter rounded-lg hover:bg-primary-darker items-center justify-center w-full h-full">
