<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
    <!-- Card 1: Just Carpets -->
    <div class="bg-primary overflow-hidden shadow-lg hover:shadow-2xl bg-primary-darker transition-shadow duration-300 flex flex-col">
        <img src="{{ asset('storage/projects/just_carpets.png') }}" alt="Just Carpets Custom Mats" class="w-full h-48 object-contain flex-shrink-0">
        <div class="p-4 bg-primary-darker flex flex-col justify-between flex-1">
            ...
            <div class="flex justify-between items-center mt-auto">
                ...
                <a href="https://justcarpets.nl" target="_blank" class="px-3 py-1 border border-primary-darkest text-primary-content rounded hover:bg-primary-darkest hover:text-primary-lighter transition-colors">Visit Website</a>
            </div>
        </div>
    </div>
    ...
    <div class="bg-primary overflow-hidden shadow-lg hover:shadow-2xl bg-primary-darker transition-shadow duration-300 flex flex-col">
        <img src="{{ asset('storage/projects/bunzlau_castle.png') }}" alt="Bunzlau Castle Tableware" class="w-full h-48 object-contain flex-shrink-0">
        <div class="p-4 bg-primary-darker flex flex-col justify-between flex-1">
            ...
            <div class="flex justify-between items-center mt-auto">
                <a href="#" class="text-sm text-primary-lighter font-semibold hover:underline">Read More</a>
                <a href="https://bunzlaucastle.com" target="_blank" class="px-3 py-1 border border-primary-darkest text-primary-content rounded hover:bg-primary-darkest hover:text-primary-lighter transition-colors">Visit Website</a>
            </div>
        </div>
    </div>
    ...
    <div class="bg-primary overflow-hidden shadow-lg hover:shadow-2xl bg-primary-darker transition-shadow duration-300 flex flex-col">
        <img src="{{ asset('storage/projects/project_gezond.png') }}" alt="Project Gezond App Interface" class="w-full h-48 object-contain flex-shrink-0">
        <div class="p-4 flex-col flex justify-between flex-1">
            ...
            <div class="flex justify-between items-center mt-auto">
                <a href="#" class="text-sm text-primary-lighter font-semibold hover:underline">Read More</a>
                <a href="https://projectgezond.nl" target="_blank" class="px-3 py-1 border border-primary-darkest text-primary-content rounded hover:bg-primary-darkest hover:text-primary-lighter transition-colors">Visit Website</a>
            </div>
        </div>
    </div>
</div>
