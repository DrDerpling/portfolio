...
>
    ...
    <div x-show="activeSlide === 2" :key="2"
         class="px-24 px-12  py-4 flex items-center bg-secondary border border-primary-darkest">
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            <div class="overflow-hidden shadow-lg hover:shadow-2xl bg-primary-darkest transition-shadow duration-300 flex flex-col">
                <img src="{{ asset('storage/projects/project_gezond.png') }}" alt="Project Gezond App Interface"
                     class="w-full h-48 object-contain flex-shrink-0">
    ...
    <div x-show="activeSlide === 3" :key="3"
         class="px-24  py-4 flex items-center bg-primary-darkest border border-primary-darkest">
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            <div class="overflow-hidden shadow-lg hover:shadow-2xl bg-primary-darker transition-shadow duration-300 flex flex-col">
                <img src="{{ asset('storage/projects/project_gezond.png') }}" alt="Project Gezond App Interface"
                     class="w-full h-48 object-contain flex-shrink-0 border-b border-primary-darkest">
    ...
    <div x-show="activeSlide === 4" :key="4"
         class="px-24 py-4 flex items-center bg-primary-lighter border border-primary-darkest">
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            <div class="overflow-hidden shadow-lg hover:shadow-2xl bg-primary-darkest transition-shadow duration-300 flex flex-col">
                <img src="{{ asset('storage/projects/project_gezond.png') }}" alt="Project Gezond App Interface"
                     class="w-full h-48 object-contain flex-shrink-0">
    ...
    <div x-show="activeSlide === 5" :key="5"
         class="px-24 py-4 flex items-center bg-primary-darker border border-primary-darkest">
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            <div class="overflow-hidden shadow-lg hover:shadow-2xl bg-primary-darkest transition-shadow duration-300 flex flex-col">
                <img src="{{ asset('storage/projects/project_gezond.png') }}" alt="Project Gezond App Interface"
                     class="w-full h-48 object-contain flex-shrink-0 border-b border-primary-darkest">
    ...
    <div class="absolute inset-0 flex">
        <div class="flex items-center justify-start w-1/2">
            <button
                    class="bg-secondary flex justify-center items-center text-center text-lg text-primary hover:text-darkest hover:shadow-lg rounded-full w-12 h-12"
                    x-on:click="activeSlide = activeSlide === 1 ? slides.length : activeSlide - 1">
                <x-feather-icon name="chevron-left" className="h-6 w-6 stroke-2"/>
            </button>
        </div>
        <div class="flex items-center justify-end w-1/2">
            <button
                    class="bg-secondary flex justify-center items-center text-center text-lg text-primary hover:text-primary-lighter hover:shadow-lg rounded-full w-12 h-12"
                    x-on:click="activeSlide = activeSlide === slides.length ? 1 : activeSlide + 1">
                <x-feather-icon name="chevron-right" className="h-6 w-6 stroke-2"/>
            </button>
        </div>
    </div>
